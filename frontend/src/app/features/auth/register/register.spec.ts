...
describe('Register', () => {
  ...
  it('moves through SMS verification and account details', () => {
    ...
    component.profileForm.setValue({ fullName: 'Nguyen Van A', password: 'password123', confirmPassword: 'password123' });
  ...
  it('rejects mismatched passwords', () => {
    component.profileForm.setValue({ fullName: 'Nguyen Van A', password: 'password123', confirmPassword: 'password321' });
